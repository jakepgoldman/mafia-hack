...
import {
  createPlayerKilledByNomination,
  createPlayerKilledStory,
} from "../prompts/NarratorPrompt";
...
export default class Narrator {
  ...
  public async narrateDeathEvent(
  ...
  public async narrateVotesResult(
    killedPlayerName: string,
    killedPlayerType: string,
    remainingPlayers: Player[],
    transcript: string,
    gameStatus: string
  ) {
